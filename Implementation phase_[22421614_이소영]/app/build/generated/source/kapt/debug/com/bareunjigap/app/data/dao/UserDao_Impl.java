  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`userId`,`email`,`password`,`name`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `userId` = ?,`email` = ?,`password` = ?,`name` = ?,`createdAt` = ? WHERE `userId` = ?";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpUserId,_tmpEmail,_tmpPassword,_tmpName,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
